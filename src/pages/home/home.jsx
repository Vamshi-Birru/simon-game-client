...
const location=useNavigate();
  ...
  const getAllScores=async()=>{
    try{
       const allScores=await axios.get("https://simon-game-server.onrender.com/user/allScores");
  ...
  useEffect( ()=>{
    ...
    const findScore=async()=>{
      ...
      try{
        const res=await axios.post(`https://simon-game-server.onrender.com/user`,{username:name});
